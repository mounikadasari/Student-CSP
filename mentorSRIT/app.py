            ...
            for i in teamname:
                ...
                for i in id:
                    ...
                    for i in filename:
                        ...
                        url = storage.child('images').child(str(i)[:]).get_url(None)
                        print(url)
                        conn4 = MySQLdb.connect(host="185.28.21.1", user="u320202036_mentor", password="Conzura9346@",
                                               database="u320202036_mentor", port=3306)
                        cu=conn4.cursor()
                        cu.execute("update team_manage set link='{}' where tamname='{}'".format(url,teamn))
                        conn4.commit()
